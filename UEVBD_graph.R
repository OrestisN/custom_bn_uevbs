...
Spectral_efficiency_HIGH.prob <- array(veccreate("C:/Users/oneoc/Desktop/Career/RISE internship stuff/Spectral efficiency HIGH_ CQI HIGH CQI MEDIUM CQI LOW.csv"),dim = c(2,2,2,2),
...
Spectral_efficiency_MEDIUM.prob <- array(veccreate("C:/Users/oneoc/Desktop/Career/RISE internship stuff/Spectral efficiency MEDIUM _CQI HIGH CQI MEDIUM CQI LOW.csv"),dim = c(2,2,2,2),
...
Spectral_efficiency_LOW.prob <- array(veccreate("C:/Users/oneoc/Desktop/Career/RISE internship stuff/Spectral efficiency LOW_CQI HIGH CQI MEDIUM CQI LOW.csv"),dim = c(2,2,2,2),
...
Overall_resources_HIGH.prob <- array(veccreate("C:/Users/oneoc/Desktop/Career/RISE internship stuff/Overall resources HIGH_SE HIGH SE MEDIUM SE LOW EE HIGH EE MEDIUM EE LOW.csv"),dim = c(2,2,2,2,2,2,2),
...
Overall_resources_MEDIUM.prob <- array(veccreate("C:/Users/oneoc/Desktop/Career/RISE internship stuff/Overall resources MEDIUM_SE HIGH SE MEDIUM SE LOW EE HIGH EE MEDIUM EE LOW.csv"),dim = c(2,2,2,2,2,2,2),
...
Overall_resources_LOW.prob <- array(veccreate("C:/Users/oneoc/Desktop/Career/RISE internship stuff/Overall resources LOW_SE HIGH SE MEDIUM SE LOW EE HIGH EE MEDIUM EE LOW.csv"),dim = c(2,2,2,2,2,2,2),
...
Backhaul_data_enough.prob <- array(veccreate("C:/Users/oneoc/Desktop/Career/RISE internship stuff/Backhaul data enough_Overall resources HIGH Overall resources MEDIUM Overall resources LOW.csv"),dim = c(2,2,2,2),
...
In_proximity_of_a_UE_VBS_device_located_in_a_high_outage_probability_area.prob <- array(veccreate("C:/Users/oneoc/Desktop/Career/RISE internship stuff/In proximity of a UE-VBS in unreachable are_Outage probability good In proximity of other UE-VBSs.csv"),dim = c(2,2,2),
...
In_proximity_of_UE_VBS_SC_devices.prob <- array(veccreate("C:/Users/oneoc/Desktop/Career/RISE internship stuff/In proximity of UE-VBS-SC device_In proximity of other UE-VBSs.csv"),dim = c(2,2),
                                                dimnames = list(In_proximity_of_UE_VBS_SC_devices = In_proximity_of_UE_VBS_SC_devices.lv,
                                                                In_proximity_of_other_UE_VBS_devices=In_proximity_of_other_UE_VBS_devices.lv))
Cellular_regular_operation.lv <- c("T","F")
Cellular_regular_operation.prob <- array(veccreate("C:/Users/oneoc/Desktop/Career/RISE internship stuff/Cellular regular operation_CQI HIGH CQI MEDIUM CQI LOW.csv"),dim = c(2,2,2,2),
...
Relay_operation.prob <- array(veccreate("C:/Users/oneoc/Desktop/Career/RISE internship stuff/Relay operation_In proximity of UE-VBS+unreachable In proximity of other UE-VBS-CS UE-VBS device backhaul data enough.csv"),dim = c(2,2,2,2,2),
...
Cluster_head_operation.prob <- array(veccreate("C:/Users/oneoc/Desktop/Career/RISE internship stuff/Cluster head operation_Backhaul data enough EU-VBS device in proximity of other UE-clients.csv"),dim = c(2,2,2,2),
...
Cluster_member_operation.prob <- array(veccreate("C:/Users/oneoc/Desktop/Career/RISE internship stuff/Cluster member operation_CQI HIGH CQI MEDIUM CQI LOW in proximity of UE-VBS-SC device.csv"),dim = c(2,2,2,2,2),
...
print(cpquery(BN,
              event = (Relay_operation=="T"),
              evidence = list(UE_VBS_Device = "T",In_proximity_of_UE_VBS_SC_devices = "T",Backhaul_data_enough= "T"),
              method = "lw"))
